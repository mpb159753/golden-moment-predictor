...
GMP (Golden Moment Predictor) 是一个基于气象数据的川西旅行景观预测引擎，能够预测**日照金山、云海、观星、雾凇、赏雪、冰挂**等自然景观的出现概率，帮助旅行者选择最佳出行时机。
...
| SnowTreePlugin | `snow_tree` | 赏雪评分 | 冬季 |
